...
urlpatterns = [
    ...
    path('bookmarks/<int:bookmark_id>/assoc_tag/<int:tag_id>/', views.assoc_tag, name='assoc_tag'),
    path('bookmarks/<int:bookmark_id>/unassoc_tag/<int:tag_id>/', views.unassoc_tag, name='unassoc_tag'),
] 